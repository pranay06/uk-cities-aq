...
-Lazy loading the weather components since they are not needed initially
-Make it more accessible
-Remove few libraries to further decrease the size of it
-Add hell lot lof tests for unit as well as end to end.
